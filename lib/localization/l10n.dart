...
class FormBuilderLocalizations {
  ...
  static FormBuilderLocalizations get current {
    assert(_current != null, 'No instance of FormBuilderLocalizations was loaded. Try to initialize the FormBuilderLocalizations delegate before accessing FormBuilderLocalizations.current.');
    return _current!;
  }
  ...
  static FormBuilderLocalizations of(BuildContext context) {
    ...
    assert(instance != null, 'No instance of FormBuilderLocalizations present in the widget tree. Did you add FormBuilderLocalizations.delegate in localizationsDelegates?');
    return instance!;
  }

  static FormBuilderLocalizations? maybeOf(BuildContext context) {
    return Localizations.of<FormBuilderLocalizations>(context, FormBuilderLocalizations);
  }
...
class AppLocalizationDelegate extends LocalizationsDelegate<FormBuilderLocalizations> {
  ...
  @override
  Future<FormBuilderLocalizations> load(Locale locale) => FormBuilderLocalizations.load(locale);
  @override
