...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(value) => "Il valore di questo campo deve essere uguale a ${value}.";

  static m1(max) => "Il valore inserito deve essere minore o uguale a ${max}";

  static m2(maxLength) => "Il valore inserito deve avere una lunghezza minore o uguale a ${maxLength}";

  static m3(min) => "Il valore inserito deve essere maggiore o uguale a ${min}.";

  static m4(minLength) => "Il valore inserito deve avere una lunghezza maggiore o uguale a ${minLength}";
