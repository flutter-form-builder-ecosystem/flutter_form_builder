...
It wraps common input types with FormField allowing validation, change detection, setting input value etc and have them in a single form

On submission, the form returns a `Map<String, dynamic>` if the form is valid or `null` otherwise  
